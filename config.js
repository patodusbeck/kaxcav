module.exports = {
    ...
    oneac: 'suas dúvidas...',
    twoac: 'ideias ✦',
    threeac: 'Vem pro Prisma! ✦',

    // Embed

    title: 'Central de Atendimento do Prisma Roleplay',
    thumbnail: 'https://media.discordapp.net/attachments/1115114682781544458/1115416326668816434/logo_essenze_v1.png?',
    image: 'https://media.discordapp.net/attachments/1115114682781544458/1125277514487582920/unknown.png?',
    color: '#9c89ad',

    // Ticket configuration 
    ticketName: ':ticket:-',
    ticketDescription: '✦ Ticket Criado por',
    ticketCreate: '\`✅\` Você abriu um Ticket com sucesso!',
    ticketAlreadyExist: 'Você já tem um ticket aberto.',
    ticketNoPermissions: 'Você não tem permissão pra isso.',
